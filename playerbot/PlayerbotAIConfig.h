...
public:
    ...
    uint32 retirementAllianceBidBrokerGuid = 0;
    uint32 retirementAllianceBidBrokerAccount = 0;
    uint32 retirementHordeBidBrokerGuid = 0;
    uint32 retirementHordeBidBrokerAccount = 0;
    bool retirementAuctionEnabled = true;
    uint32 retirementAuctionMaxAttempts = 5;
    uint32 retirementAuctionRepostDelay = 3600;
    uint32 retirementAuctionDiscountPercentPerAttempt = 10;
    uint32 retirementAuctionDuration = 43200;
    uint32 retirementEstateBatchSize = 10;
